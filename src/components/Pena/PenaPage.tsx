          ...
          <div className="">
            ...
            <div>
              ...
              <div className="mt-2 grid grid-cols-2">
                <IoMdPhotos className="text-xl text-slate-400 hover:text-purple-600 cursor-pointer active:text-slate-400 transition" />
                <button className="-mt-0.5 bg-purple-600 outline-none ml-[100px] lg:ml-[122px] w-max text-white py-1 px-2 rounded-sm font-semibold text-md hover:bg-purple-900 transition active:bg-purple-600">
                  Submit
                </button>
              </div>
            </div>
              ...
              <div className="mt-5 text-slate-400">
                <div className="grid grid-cols-9">
                  <button onClick={onOpen}>
                    <FaCommentAlt className="hover:text-purple-600 cursor-pointer active:text-slate-400 transition" />
                  </button>
                  <button className="flex hover:text-purple-600 cursor-pointer active:text-slate-400 transition">
